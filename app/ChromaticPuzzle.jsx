...
const CHAPTERS = [
  ...
  { name: "Insane I", range: [141, 146], color: "#dc2626", bg: "radial-gradient(circle at bottom right,#450a0a 0%,#1a0505 40%,#0a0a0a 100%)", glow: "rgba(220,38,38,0.2)" }
];
