...
{ number: 137, name: "Master Plan", cells: ["A","B","C","D","E","F","G","H","I","J","K","L","M","N","O","P"], layout: [[["P","M","L","K"],["O","N",null,"J"],[null,null,null,null],[null,null,"H","I"]],[[null,null,null,"A"],[null,null,null,"B"],[null,"E","D","C"],[null,"F","G",null]]], pieces: ["OUT:RED|CYAN:DOWN","CYAN|RED:DOWN","PIPE:UP:RED>LEFT:BLUE","BLUE|PURPLE:LEFT","PURPLE|GREEN:DOWN","TRIGGER:GREEN:E|YELLOW:RIGHT","STAIRS:DOWN:YELLOW|BLUE:SHELF_DOWN","BLUE|GREEN:RIGHT","GREEN|ORANGE:UP:2","ORANGE|BLUE:UP","BLUE|RED:LEFT","PIPE:RIGHT:RED>LEFT:ORANGE","ORANGE|RED:DOWN","RED|GREEN:LEFT","GREEN|RED:UP","IN:RED"], solution: {"A":"OUT:RED|CYAN:DOWN","B":"CYAN|RED:DOWN","C":"PIPE:UP:RED>LEFT:BLUE","D":"BLUE|PURPLE:LEFT","E":"PURPLE|GREEN:DOWN","F":"TRIGGER:GREEN:E|YELLOW:RIGHT","G":"STAIRS:DOWN:YELLOW|BLUE:SHELF_DOWN","H":"BLUE|GREEN:RIGHT","I":"GREEN|ORANGE:UP:2","J":"ORANGE|BLUE:UP","K":"BLUE|RED:LEFT","L":"PIPE:RIGHT:RED>LEFT:ORANGE","M":"ORANGE|RED:DOWN","N":"RED|GREEN:LEFT","O":"GREEN|RED:UP","P":"IN:RED"}, hint: "Use all pieces correctly!" },
...
const CHAPTERS = [
  ...
  { name: "Master VII", range: [141, 145], color: "#f43f5e", bg: "radial-gradient(circle at center,#4c0519 0%,#0f0205 100%)", glow: "rgba(244,63,94,0.18)" },
  { name: "Calm", range: [146, 155], color: "#67e8f9", bg: "radial-gradient(circle at center,#083344 0%,#0c1424 60%,#0a0a15 100%)", glow: "rgba(103,232,249,0.12)" },
  { name: "Insane I", range: [156, 161], color: "#dc2626", bg: "radial-gradient(circle at bottom right,#450a0a 0%,#1a0505 40%,#0a0a0a 100%)", glow: "rgba(220,38,38,0.2)" }
];
