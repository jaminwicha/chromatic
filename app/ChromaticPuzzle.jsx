...
const CHAPTERS = [
  ...
  { name: "Calm II", range: [156, 165], color: "#86efac", bg: "radial-gradient(circle at center,#052e16 0%,#0a1a10 60%,#0a0a15 100%)", glow: "rgba(134,239,172,0.12)" },
  { name: "Calm III", range: [166, 175], color: "#c4b5fd", bg: "radial-gradient(circle at center,#1e1b4b 0%,#0f0d24 60%,#0a0a15 100%)", glow: "rgba(196,181,253,0.12)" },
  { name: "Calm IV", range: [176, 185], color: "#fca5a5", bg: "radial-gradient(circle at center,#450a0a 0%,#1a0808 60%,#0a0a15 100%)", glow: "rgba(252,165,165,0.12)" },
  { name: "Calm V", range: [186, 195], color: "#fdba74", bg: "radial-gradient(circle at center,#431407 0%,#1a0e05 60%,#0a0a15 100%)", glow: "rgba(253,186,116,0.12)" },
  { name: "Insane I", range: [196, 201], color: "#dc2626", bg: "radial-gradient(circle at bottom right,#450a0a 0%,#1a0505 40%,#0a0a0a 100%)", glow: "rgba(220,38,38,0.2)" }
];
