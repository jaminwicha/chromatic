    ...
    for (let r = 0; r < l3d[z].length; r++) {
      for (let c = 0; c < l3d[z][r].length; c++) {
        ...
        for (const conn of tile.connections) {
          ...
          // Wall check: block if target cell has a wall on the arrival side
...
const CHAPTERS = [
  ...
  { name: "Insane I", range: [244, 249], color: "#dc2626", bg: "radial-gradient(circle at bottom right,#450a0a 0%,#1a0505 40%,#0a0a0a 100%)", glow: "rgba(220,38,38,0.2)" },
  { name: "Insane II", range: [250, 255], color: "#ef4444", bg: "radial-gradient(circle at center,#7f1d1d 0%,#1a0505 60%,#0a0a15 100%)", glow: "rgba(239,68,68,0.15)" },
  { name: "Insane III", range: [256, 261], color: "#dc2626", bg: "radial-gradient(circle at center,#991b1b 0%,#1a0505 60%,#0a0a15 100%)", glow: "rgba(220,38,38,0.15)" }
];
...
function GridCell({ cellName, displayLabel, size, tile, hasError, onClick, isTarget, isLockedCell, currentChapter, flashColor, displayLabelMap, walls }) {
...
export default function ChromaticPuzzle() {
  ...
  const DATA_VERSION = 6; // v1: 215 levels, v2: 225 levels (conduits chapter inserted at index 209)
  useEffect(() => {
