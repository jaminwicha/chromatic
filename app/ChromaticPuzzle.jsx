...
const LEVELS = [
  ...
  {number:60,name:"Chromatic Nexus",cells:["A","B","C","D","E","F","G","H","I","J","K","L"],layout:[["A","B","C","D"],["E","F","G","H"],["I","J","K","L"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","RED|GREEN:RIGHT","GREEN|ORANGE:RIGHT,PURPLE:DOWN","IN:ORANGE","BLUE|CYAN:RIGHT,RED:DOWN","CYAN|BLUE:LEFT","PURPLE|PINK:RIGHT","PINK|PURPLE:LEFT","RED|YELLOW:RIGHT","YELLOW|BLUE:RIGHT","BLUE|GREEN:RIGHT","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"RED|GREEN:RIGHT",C:"GREEN|ORANGE:RIGHT,PURPLE:DOWN",D:"IN:ORANGE",E:"BLUE|CYAN:RIGHT,RED:DOWN",F:"CYAN|BLUE:LEFT",G:"PURPLE|PINK:RIGHT",H:"PINK|PURPLE:LEFT",I:"RED|YELLOW:RIGHT",J:"YELLOW|BLUE:RIGHT",K:"BLUE|GREEN:RIGHT",L:"IN:GREEN"},hint:"12 tiles, 3 connected rows. The nexus!"},
  // === CHAPTER 8: PIPES (61-70) ===
  {number:61,name:"First Pipe",cells:["A","B","C"],layout:[["A","B","C"]],pieces:["RED|RED:RIGHT","PIPE:LEFT:RED>RIGHT:BLUE","IN:BLUE"],solution:{A:"RED|RED:RIGHT",B:"PIPE:LEFT:RED>RIGHT:BLUE",C:"IN:BLUE"},hint:"The pipe transforms RED into BLUE! New tile type."},
  {number:62,name:"Pipe Relay",cells:["A","B","C"],layout:[["A","B","C"]],pieces:["OUT:RED|RED:RIGHT","PIPE:LEFT:RED>RIGHT:GREEN","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT",B:"PIPE:LEFT:RED>RIGHT:GREEN",C:"IN:GREEN"},hint:"Source → pipe → sink. The pipe changes the color."},
  {number:63,name:"Double Transform",cells:["A","B","C","D"],layout:[["A","B","C","D"]],pieces:["RED|RED:RIGHT","PIPE:LEFT:RED>RIGHT:BLUE","PIPE:LEFT:BLUE>RIGHT:GREEN","IN:GREEN"],solution:{A:"RED|RED:RIGHT",B:"PIPE:LEFT:RED>RIGHT:BLUE",C:"PIPE:LEFT:BLUE>RIGHT:GREEN",D:"IN:GREEN"},hint:"Two pipes chain: RED→BLUE→GREEN."},
  {number:64,name:"Pipe or Normal?",cells:["A","B","C","D"],layout:[["A","B","C","D"]],pieces:["OUT:RED|RED:RIGHT","PIPE:LEFT:RED>RIGHT:BLUE","BLUE|GREEN:RIGHT","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT",B:"PIPE:LEFT:RED>RIGHT:BLUE",C:"BLUE|GREEN:RIGHT",D:"IN:GREEN"},hint:"Mix of pipe and normal tile. Which goes where?"},
  {number:65,name:"Pipe Bend",cells:["A","B","C"],layout:[["A","B"],[null,"C"]],pieces:["RED|RED:RIGHT","PIPE:LEFT:RED>DOWN:BLUE","IN:BLUE"],solution:{A:"RED|RED:RIGHT",B:"PIPE:LEFT:RED>DOWN:BLUE",C:"IN:BLUE"},hint:"This pipe bends — enters left, exits downward."},
  {number:66,name:"Cross Pipe",cells:["A","B","C","D","E"],layout:[[null,"A",null],["B","C","D"],[null,"E",null]],pieces:["RED|RED:DOWN","BLUE|BLUE:RIGHT","PIPE:UP:RED>DOWN:GREEN,LEFT:BLUE>RIGHT:PURPLE","IN:PURPLE","IN:GREEN"],solution:{A:"RED|RED:DOWN",B:"BLUE|BLUE:RIGHT",C:"PIPE:UP:RED>DOWN:GREEN,LEFT:BLUE>RIGHT:PURPLE",D:"IN:PURPLE",E:"IN:GREEN"},hint:"Cross pipe has TWO channels! Signals pass through independently."},
  {number:67,name:"Pipe Fork",cells:["A","B","C","D"],layout:[["A","B"],["C","D"]],pieces:["RED|RED:RIGHT,GREEN:DOWN","PIPE:LEFT:RED>DOWN:BLUE","GREEN|PURPLE:RIGHT","IN:BLUE,PURPLE"],solution:{A:"RED|RED:RIGHT,GREEN:DOWN",B:"PIPE:LEFT:RED>DOWN:BLUE",C:"GREEN|PURPLE:RIGHT",D:"IN:BLUE,PURPLE"},hint:"A sends two signals. One goes through the pipe."},
  {number:68,name:"Pipe Snipe",cells:["A","B","C","D"],layout:[["A","B","C","D"]],pieces:["RED|RED:RIGHT:2","PURPLE|RED:LEFT","PIPE:LEFT:RED>RIGHT:BLUE","IN:BLUE"],solution:{A:"RED|RED:RIGHT:2",B:"PURPLE|RED:LEFT",C:"PIPE:LEFT:RED>RIGHT:BLUE",D:"IN:BLUE"},hint:"A jumps over B to reach C's pipe!"},
  {number:69,name:"L-Pipe Chain",cells:["A","B","C","D"],layout:[["A","B"],[null,"C"],[null,"D"]],pieces:["OUT:RED|RED:RIGHT","PIPE:LEFT:RED>DOWN:BLUE","PIPE:UP:BLUE>DOWN:GREEN","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT",B:"PIPE:LEFT:RED>DOWN:BLUE",C:"PIPE:UP:BLUE>DOWN:GREEN",D:"IN:GREEN"},hint:"Two bending pipes form an L-shaped path."},
  {number:70,name:"Pipe Star",cells:["A","B","C","D","E"],layout:[[null,"A",null],["B","C","D"],[null,"E",null]],pieces:["OUT:RED|RED:DOWN","OUT:BLUE|BLUE:RIGHT","PIPE:UP:RED>DOWN:GREEN,LEFT:BLUE>RIGHT:PURPLE","IN:PURPLE","IN:GREEN"],solution:{A:"OUT:RED|RED:DOWN",B:"OUT:BLUE|BLUE:RIGHT",C:"PIPE:UP:RED>DOWN:GREEN,LEFT:BLUE>RIGHT:PURPLE",D:"IN:PURPLE",E:"IN:GREEN"},hint:"Two sources feed a cross pipe. Two sinks absorb."},
  // === CHAPTER 9: MASTER (71-80) ===
  {number:71,name:"Pipe Cascade",cells:["A","B","C","D","E","F","G","H","I","J","K","L"],layout:[["A","B","C","D"],["E","F","G","H"],["I","J","K","L"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>RIGHT:GREEN","GREEN|ORANGE:RIGHT","IN:ORANGE","BLUE|CYAN:RIGHT","PIPE:LEFT:CYAN>RIGHT:PURPLE","PURPLE|PINK:RIGHT","IN:PINK","RED|YELLOW:RIGHT","YELLOW|GREEN:RIGHT","GREEN|BLUE:RIGHT","IN:BLUE"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>RIGHT:GREEN",C:"GREEN|ORANGE:RIGHT",D:"IN:ORANGE",E:"BLUE|CYAN:RIGHT",F:"PIPE:LEFT:CYAN>RIGHT:PURPLE",G:"PURPLE|PINK:RIGHT",H:"IN:PINK",I:"RED|YELLOW:RIGHT",J:"YELLOW|GREEN:RIGHT",K:"GREEN|BLUE:RIGHT",L:"IN:BLUE"},hint:"12 tiles with 2 pipes transforming colors across parallel lanes."},
  {number:72,name:"Transform Junction",cells:["A","B","C","D","E","F","G","H","I"],layout:[["A","B","C"],["D","E","F"],["G","H","I"]],pieces:["OUT:RED|RED:RIGHT,GREEN:DOWN","PIPE:LEFT:RED>RIGHT:BLUE","IN:BLUE","GREEN|ORANGE:RIGHT,CYAN:DOWN","PIPE:LEFT:ORANGE>DOWN:PURPLE,UP:CYAN>RIGHT:YELLOW","IN:YELLOW","CYAN|PINK:RIGHT","PURPLE|PINK:LEFT","IN:PINK"],solution:{A:"OUT:RED|RED:RIGHT,GREEN:DOWN",B:"PIPE:LEFT:RED>RIGHT:BLUE",C:"IN:BLUE",D:"GREEN|ORANGE:RIGHT,CYAN:DOWN",E:"PIPE:LEFT:ORANGE>DOWN:PURPLE,UP:CYAN>RIGHT:YELLOW",F:"IN:YELLOW",G:"CYAN|PINK:RIGHT",H:"PURPLE|PINK:LEFT",I:"IN:PINK"},hint:"Multi-channel pipe at E transforms 2 signals simultaneously!"},
  {number:73,name:"Sniper Pipes",cells:["A","B","C","D","E","F","G","H","I","J"],layout:[["A","B","C","D","E"],["F","G","H","I","J"]],pieces:["OUT:RED|RED:RIGHT,BLUE:RIGHT:3","RED|GREEN:RIGHT","PIPE:LEFT:GREEN>RIGHT:ORANGE","ORANGE|PURPLE:RIGHT","IN:PURPLE","BLUE|CYAN:RIGHT","CYAN|PINK:RIGHT","PIPE:LEFT:PINK>RIGHT:YELLOW","YELLOW|GREEN:RIGHT","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:RIGHT:3",B:"RED|GREEN:RIGHT",C:"PIPE:LEFT:GREEN>RIGHT:ORANGE",D:"ORANGE|PURPLE:RIGHT",E:"IN:PURPLE",F:"BLUE|CYAN:RIGHT",G:"CYAN|PINK:RIGHT",H:"PIPE:LEFT:PINK>RIGHT:YELLOW",I:"YELLOW|GREEN:RIGHT",J:"IN:GREEN"},hint:"Distance-3 jump combined with pipe transformations!"},
  {number:74,name:"Pipe Matrix",cells:["A","B","C","D","E","F","G","H","I","J","K","L"],layout:[["A","B","C","D"],["E","F","G","H"],["I","J","K","L"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>DOWN:GREEN","GREEN|ORANGE:RIGHT","IN:ORANGE","BLUE|CYAN:RIGHT,PURPLE:DOWN","PIPE:LEFT:CYAN>RIGHT:PINK,UP:PURPLE>DOWN:YELLOW","IN:PINK","PIPE:UP:YELLOW>RIGHT:CYAN","PURPLE|RED:RIGHT","RED|CYAN:LEFT","CYAN|GREEN:RIGHT","IN:GREEN"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>DOWN:GREEN",C:"GREEN|ORANGE:RIGHT",D:"IN:ORANGE",E:"BLUE|CYAN:RIGHT,PURPLE:DOWN",F:"PIPE:LEFT:CYAN>RIGHT:PINK,UP:PURPLE>DOWN:YELLOW",G:"IN:PINK",H:"PIPE:UP:YELLOW>RIGHT:CYAN",I:"PURPLE|RED:RIGHT",J:"RED|CYAN:LEFT",K:"CYAN|GREEN:RIGHT",L:"IN:GREEN"},hint:"3 pipes create a complex transformation matrix!"},
  {number:75,name:"Diagonal Pipes",cells:["A","B","C","D","E","F","G","H","I"],layout:[["A","B","C"],["D","E","F"],["G","H","I"]],pieces:["OUT:RED|RED:RIGHT,GREEN:DOWN_RIGHT","RED|BLUE:RIGHT","IN:BLUE","GREEN|ORANGE:DOWN","PIPE:UP:ORANGE>RIGHT:PURPLE,UP_LEFT:GREEN>DOWN:CYAN","IN:PURPLE","CYAN|PINK:RIGHT","PIPE:LEFT:PINK>DOWN:YELLOW","IN:YELLOW"],solution:{A:"OUT:RED|RED:RIGHT,GREEN:DOWN_RIGHT",B:"RED|BLUE:RIGHT",C:"IN:BLUE",D:"GREEN|ORANGE:DOWN",E:"PIPE:UP:ORANGE>RIGHT:PURPLE,UP_LEFT:GREEN>DOWN:CYAN",F:"IN:PURPLE",G:"CYAN|PINK:RIGHT",H:"PIPE:LEFT:PINK>DOWN:YELLOW",I:"IN:YELLOW"},hint:"Diagonal arrows meet pipes! E handles diagonal input."},
  {number:76,name:"Grand Transformer",cells:["A","B","C","D","E","F","G","H","I","J","K","L","M","N"],layout:[[null,"A","B",null],[null,"C","D",null],["E","F","G","H"],["I","J","K","L"],[null,"M","N",null]],pieces:["OUT:RED|RED:DOWN","RED|BLUE:DOWN","PIPE:UP:BLUE>DOWN:GREEN","GREEN|ORANGE:LEFT,CYAN:RIGHT","IN:CYAN","ORANGE|PURPLE:DOWN","PIPE:LEFT:ORANGE>DOWN:YELLOW,UP:PURPLE>RIGHT:PINK","PINK|RED:RIGHT","IN:RED","YELLOW|GREEN:DOWN","GREEN|BLUE:RIGHT","BLUE|CYAN:RIGHT","CYAN|PURPLE:DOWN","IN:PURPLE"],solution:{A:"OUT:RED|RED:DOWN",B:"RED|BLUE:DOWN",C:"PIPE:UP:BLUE>DOWN:GREEN",D:"GREEN|ORANGE:LEFT,CYAN:RIGHT",E:"IN:CYAN",F:"ORANGE|PURPLE:DOWN",G:"PIPE:LEFT:ORANGE>DOWN:YELLOW,UP:PURPLE>RIGHT:PINK",H:"PINK|RED:RIGHT",I:"IN:RED",J:"YELLOW|GREEN:DOWN",K:"GREEN|BLUE:RIGHT",L:"BLUE|CYAN:RIGHT",M:"CYAN|PURPLE:DOWN",N:"IN:PURPLE"},hint:"14 tiles! Vertical tower with 2 pipes transforming the flow."},
  {number:77,name:"Pipe Nexus",cells:["A","B","C","D","E","F","G","H","I","J","K","L"],layout:[["A","B","C","D"],["E","F","G","H"],["I","J","K","L"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>RIGHT:GREEN,UP:BLUE>DOWN:ORANGE","GREEN|PURPLE:RIGHT","IN:PURPLE","BLUE|CYAN:RIGHT","ORANGE|PINK:RIGHT,CYAN:DOWN","PIPE:LEFT:PINK>RIGHT:YELLOW","IN:YELLOW","RED|GREEN:RIGHT:2","CYAN|BLUE:RIGHT","BLUE|RED:RIGHT","IN:RED"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>RIGHT:GREEN,UP:BLUE>DOWN:ORANGE",C:"GREEN|PURPLE:RIGHT",D:"IN:PURPLE",E:"BLUE|CYAN:RIGHT",F:"ORANGE|PINK:RIGHT,CYAN:DOWN",G:"PIPE:LEFT:PINK>RIGHT:YELLOW",H:"IN:YELLOW",I:"RED|GREEN:RIGHT:2",J:"CYAN|BLUE:RIGHT",K:"BLUE|RED:RIGHT",L:"IN:RED"},hint:"Multi-channel pipe + distance-2 jump! Complex routing."},
  {number:78,name:"Chromatic Forge",cells:["A","B","C","D","E","F","G","H","I","J","K","L","M","N","O"],layout:[["A","B","C","D","E"],["F","G","H","I","J"],["K","L","M","N","O"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>RIGHT:GREEN","GREEN|ORANGE:RIGHT","PIPE:LEFT:ORANGE>RIGHT:PURPLE","IN:PURPLE","BLUE|CYAN:RIGHT,PINK:DOWN","PIPE:LEFT:CYAN>RIGHT:YELLOW","YELLOW|RED:RIGHT","RED|GREEN:RIGHT","IN:GREEN","PINK|ORANGE:RIGHT","ORANGE|BLUE:RIGHT","PIPE:LEFT:BLUE>RIGHT:CYAN","CYAN|PURPLE:RIGHT","IN:PURPLE"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>RIGHT:GREEN",C:"GREEN|ORANGE:RIGHT",D:"PIPE:LEFT:ORANGE>RIGHT:PURPLE",E:"IN:PURPLE",F:"BLUE|CYAN:RIGHT,PINK:DOWN",G:"PIPE:LEFT:CYAN>RIGHT:YELLOW",H:"YELLOW|RED:RIGHT",I:"RED|GREEN:RIGHT",J:"IN:GREEN",K:"PINK|ORANGE:RIGHT",L:"ORANGE|BLUE:RIGHT",M:"PIPE:LEFT:BLUE>RIGHT:CYAN",N:"CYAN|PURPLE:RIGHT",O:"IN:PURPLE"},hint:"15 tiles! 4 pipes forge new colors across 3 lanes."},
  {number:79,name:"Ultimate Synthesis",cells:["A","B","C","D","E","F","G","H","I","J","K","L","M","N","O","P"],layout:[["A","B","C","D"],["E","F","G","H"],["I","J","K","L"],["M","N","O","P"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>RIGHT:GREEN","GREEN|ORANGE:RIGHT,PURPLE:DOWN","IN:ORANGE","BLUE|CYAN:RIGHT,YELLOW:DOWN","PIPE:LEFT:CYAN>DOWN:PINK,UP:PURPLE>RIGHT:RED","RED|GREEN:RIGHT","IN:GREEN","YELLOW|ORANGE:RIGHT","PINK|BLUE:RIGHT","PIPE:LEFT:BLUE>RIGHT:CYAN","IN:CYAN","ORANGE|PURPLE:RIGHT:2","PURPLE|PINK:RIGHT","PINK|YELLOW:RIGHT","IN:YELLOW"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>RIGHT:GREEN",C:"GREEN|ORANGE:RIGHT,PURPLE:DOWN",D:"IN:ORANGE",E:"BLUE|CYAN:RIGHT,YELLOW:DOWN",F:"PIPE:LEFT:CYAN>DOWN:PINK,UP:PURPLE>RIGHT:RED",G:"RED|GREEN:RIGHT",H:"IN:GREEN",I:"YELLOW|ORANGE:RIGHT",J:"PINK|BLUE:RIGHT",K:"PIPE:LEFT:BLUE>RIGHT:CYAN",L:"IN:CYAN",M:"ORANGE|PURPLE:RIGHT:2",N:"PURPLE|PINK:RIGHT",O:"PINK|YELLOW:RIGHT",P:"IN:YELLOW"},hint:"16 tiles! Multi-channel pipes, distance-2 jump, 4 sinks!"},
  {number:80,name:"Chromatic Apex",cells:["A","B","C","D","E","F","G","H","I","J","K","L","M","N","O","P","Q","R"],layout:[["A","B","C","D","E","F"],["G","H","I","J","K","L"],["M","N","O","P","Q","R"]],pieces:["OUT:RED|RED:RIGHT,BLUE:DOWN","PIPE:LEFT:RED>RIGHT:GREEN","GREEN|ORANGE:RIGHT","PIPE:LEFT:ORANGE>RIGHT:PURPLE","PURPLE|CYAN:RIGHT","IN:CYAN","BLUE|PINK:RIGHT,YELLOW:DOWN","PIPE:LEFT:PINK>DOWN:RED,UP:YELLOW>RIGHT:BLUE","BLUE|GREEN:RIGHT","GREEN|PURPLE:RIGHT","PURPLE|ORANGE:RIGHT","IN:ORANGE","YELLOW|CYAN:RIGHT","RED|PINK:RIGHT","PIPE:LEFT:PINK>RIGHT:YELLOW","YELLOW|BLUE:RIGHT:2","BLUE|RED:RIGHT","IN:RED"],solution:{A:"OUT:RED|RED:RIGHT,BLUE:DOWN",B:"PIPE:LEFT:RED>RIGHT:GREEN",C:"GREEN|ORANGE:RIGHT",D:"PIPE:LEFT:ORANGE>RIGHT:PURPLE",E:"PURPLE|CYAN:RIGHT",F:"IN:CYAN",G:"BLUE|PINK:RIGHT,YELLOW:DOWN",H:"PIPE:LEFT:PINK>DOWN:RED,UP:YELLOW>RIGHT:BLUE",I:"BLUE|GREEN:RIGHT",J:"GREEN|PURPLE:RIGHT",K:"PURPLE|ORANGE:RIGHT",L:"IN:ORANGE",M:"YELLOW|CYAN:RIGHT",N:"RED|PINK:RIGHT",O:"PIPE:LEFT:PINK>RIGHT:YELLOW",P:"YELLOW|BLUE:RIGHT:2",Q:"BLUE|RED:RIGHT",R:"IN:RED"},hint:"18 tiles! The ultimate challenge: 4 pipes, multi-channel, distance-2 jump, 3 sinks!"},
];
...
const CHAPTERS = [
  ...
  {name:"Expert",range:[55,60],color:"#ec4899"},{name:"Pipes",range:[61,70],color:"#8b5cf6"},
  {name:"Master",range:[71,80],color:"#fbbf24"},
];
...
function TilePiece({ tileStr, size=80, onClick, isDragging, isPlaced }) {
  ...
  if (isPipe) {
    ...
    return (
      <div onClick={onClick} style={{width:size,height:size,borderRadius:14,
        ...
        <div style={{width:size*0.32,height:size*0.32,borderRadius:6,background:"rgba(139,92,246,0.25)",
        ...
        {channels.map((ch,i) => {
          ...
          return [
            <div key={`in${i}`} style={{position:"absolute",...inPos,zIndex:3,display:"flex",alignItems:"center",justifyContent:"center",
            ...
            <div key={`out${i}`} style={{position:"absolute",...outPos,zIndex:3,display:"flex",alignItems:"center",justifyContent:"center",
