...
const CHAPTERS = [
  ...
  { name: "Insane I", range: [234, 239], color: "#dc2626", bg: "radial-gradient(circle at bottom right,#450a0a 0%,#1a0505 40%,#0a0a0a 100%)", glow: "rgba(220,38,38,0.2)" },
...
export default function ChromaticPuzzle() {
  ...
  const DATA_VERSION = 5; // v1: 215 levels, v2: 225 levels (conduits chapter inserted at index 209)
  useEffect(() => {
