  ...
  if (isPipe) {
    ...
    return (
      <div onClick={onClick} style={{width:size,height:size,borderRadius:14,
        ...
        <span style={{position:"absolute",top:size>60?3:1,left:"50%",transform:"translateX(-50%)",
          fontSize:Math.max(size*0.09,6),fontWeight:700,color:"rgba(139,92,246,0.8)",fontFamily:"'JetBrains Mono',monospace",
          textShadow:"0 1px 3px rgba(0,0,0,0.6)",zIndex:3}}>PIPE</span>
        ...
        {channels.map((ch,i) => {
          ...
          return [
            <div key={`in${i}`} style={{position:"absolute",...inPos,zIndex:3,display:"flex",alignItems:"center",justifyContent:"center",
              ...
              <span style={{fontSize:sz>14?9:7,color:"rgba(255,255,255,0.95)",lineHeight:1,fontWeight:700}}>IN</span>
            </div>,
...
<p style={{color:"rgba(255,255,255,0.5)",fontSize:14,fontFamily:"'JetBrains Mono',monospace",marginBottom:8}}>All 70 levels complete</p>
